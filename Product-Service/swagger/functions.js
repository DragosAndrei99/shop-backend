...
exports.default = (serverless) => {
  ...
  const authorizer =
    (_l =
      (_k = serverless.service.custom) === null || _k === void 0
        ? void 0
        : _k.autoswagger) === null || _l === void 0
      ? void 0
      : _l.lambdaAuthorizer;
  ...
  const swaggerUI = {
    ...
    events: [
      {
        [apiType]: Object.assign(
          { method: "get", path: useStage ? `/${stage}/${path}` : `/${path}` },
  ...
  const swaggerRedirectURI = (
    (_o =
      (_m = serverless.service.custom) === null || _m === void 0
        ? void 0
        : _m.autoswagger) === null || _o === void 0
      ? void 0
      : _o.useRedirectUI
  )
    ? {
        name:
          name && stage ? `${name}-${stage}-swagger-redirect-uri` : undefined,
